...
// === Fields:
// === - name (string)
// === - description (string)  // human-facing blurb
// === - enforce (string[])    // medium/technique/era tokens to push the style
// === - forbid (string[])     // tokens that conflict with the style
// === - palette (string[])    // color/material vocabulary
// === - surface (string[])    // substrate/mark-making/surface artifacts
// ============================================================================
module.exports = [
  {
